# ----------------------------------------------------------------------------#
# Please note: All todos have been removed for code readability purposes
# ----------------------------------------------------------------------------#
...
class Venue(db.Model):
    ...
    genres = db.Column(db.ARRAY(db.String()), nullable=False)  # missing field
    ...
    website = db.Column(db.String(120), nullable=False)  # missing field
    seeking_talent = db.Column(db.Boolean, default=False)  # missing field
    seeking_description = db.Column(db.String(500))  # missing field
    shows = db.relationship('Show', backref="venue", lazy=True)  # relationship
...
class Artist(db.Model):
    ...
    seeking_description = db.Column(db.String(500))  # missing field
    shows = db.relationship('Show', backref="artist", lazy=True)  # relationship
